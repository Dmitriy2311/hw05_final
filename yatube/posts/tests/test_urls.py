...
from posts.tests.test_constant import (
    URL_INDEX, URL_GROUP_LIST, URL_PROFILE, TEST_POST, PROFILE_HTML,
    URL_EDIT, AUTH, NO_AUTH, TEST_SLUG, TEST_DESCRIPT, SLUG, USER_NAME,
    URL_INDEX, URL_GROUP_LIST, URL_DETAIL, DETAIL_HTML, URL_POST_CREATE,
    INDEX_HTML, CREATE_HTML, GROUP_LIST_HTML, TEST_GROUP, URL_UNEX_PAGE,
    URL_LOGIN_CREATE, URL_PROFILE, URL_CREATE, POST_ID
)
