...
from posts.tests.test_constant import (
    URL_INDEX, URL_POST_CREATE, URL_GROUP_LIST, URL_PROFILE, TEST_POST, POST_ID, COMMENT,
    URL_EDIT, AUTH, TEST_NAME, TEST_SLUG, TEST_DISCRIP, PAGE, POST, LOGIN,
    URL_INDEX, URL_POST_CREATE, URL_GROUP_LIST, URL_DETAIL, TEST_OF_POST, FORM, USER,
